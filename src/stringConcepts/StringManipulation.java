...
public class StringManipulation {
	...
	public static void main(String[] args) {
		...
		/*
		 * When string is created, it will be stored in string constant pool (SCP) area
		 * of the heap memory in order to optimise the creation of common string
		 * values.  Duplicate objects is not allowed in SCP, meaning, if an object is
		 * already inside the SCP, and a new string is created with the same object,
		 * Java will not create another object inside SCP. After JDK 1.7, SCP is part of
		 * Heap memory.
		 */
